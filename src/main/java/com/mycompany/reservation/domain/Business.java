...
public class Business implements Serializable {
    ...
    public void setServices(Set<OfferedService> offeredServices) {
        if (this.services != null) {
            this.services.forEach(i -> i.setBusiness(null));
        }
        if (offeredServices != null) {
            offeredServices.forEach(i -> i.setBusiness(this));
        }
        this.services = offeredServices;
    }

    public Business services(Set<OfferedService> offeredServices) {
        this.setServices(offeredServices);
        return this;
    }

    public Business addServices(OfferedService offeredService) {
        this.services.add(offeredService);
        offeredService.setBusiness(this);
        return this;
    }

    public Business removeServices(OfferedService offeredService) {
        this.services.remove(offeredService);
        offeredService.setBusiness(null);
        return this;
    }
