...
public class Reservation implements Serializable {
    ...
    public void setService(OfferedService offeredService) {
        this.service = offeredService;
    }

    public Reservation service(OfferedService offeredService) {
        this.setService(offeredService);
        return this;
    }
