...
import static com.mycompany.reservation.web.rest.TestUtil.sameInstant;
...
class ReservationResourceIT {
    ...
    void putExistingReservation() throws Exception {
        ...
        updatedReservation.date(UPDATED_DATE).status(UPDATED_STATUS).notes(UPDATED_NOTES);
    ...
    void partialUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.date(UPDATED_DATE);
    ...
    void fullUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.date(UPDATED_DATE).status(UPDATED_STATUS).notes(UPDATED_NOTES);
