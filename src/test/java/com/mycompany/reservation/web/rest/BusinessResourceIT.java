...
import com.mycompany.reservation.service.mapper.BusinessMapper;
...
class BusinessResourceIT {
    ...
    private static final BusinessType DEFAULT_TYPE = BusinessType.RESTAURANT;
    private static final BusinessType UPDATED_TYPE = BusinessType.CAFE;
    ...
    void partialUpdateBusinessWithPatch() throws Exception {
        ...
        partialUpdatedBusiness.address(UPDATED_ADDRESS).email(UPDATED_EMAIL).description(UPDATED_DESCRIPTION);
