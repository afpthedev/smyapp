...
import com.mycompany.reservation.repository.PaymentRepository;
import com.mycompany.reservation.service.dto.PaymentDTO;
import com.mycompany.reservation.service.mapper.PaymentMapper;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity() {
        return new Payment().amount(DEFAULT_AMOUNT).method(DEFAULT_METHOD).status(DEFAULT_STATUS).transactionId(DEFAULT_TRANSACTION_ID);
    }
    ...
    public static Payment createUpdatedEntity() {
        return new Payment().amount(UPDATED_AMOUNT).method(UPDATED_METHOD).status(UPDATED_STATUS).transactionId(UPDATED_TRANSACTION_ID);
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.amount(UPDATED_AMOUNT).method(UPDATED_METHOD).status(UPDATED_STATUS).transactionId(UPDATED_TRANSACTION_ID);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.method(UPDATED_METHOD).status(UPDATED_STATUS).transactionId(UPDATED_TRANSACTION_ID);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.amount(UPDATED_AMOUNT).method(UPDATED_METHOD).status(UPDATED_STATUS).transactionId(UPDATED_TRANSACTION_ID);
