...
class BusinessTest {
    ...
    void servicesTest() {
        ...
        business.addServices(serviceBack);
        assertThat(business.getServices()).containsOnly(serviceBack);
        assertThat(serviceBack.getBusiness()).isEqualTo(business);

        business.removeServices(serviceBack);
        assertThat(business.getServices()).doesNotContain(serviceBack);
        assertThat(serviceBack.getBusiness()).isNull();

        business.services(new HashSet<>(Set.of(serviceBack)));
        assertThat(business.getServices()).containsOnly(serviceBack);
        assertThat(serviceBack.getBusiness()).isEqualTo(business);
