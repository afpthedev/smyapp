...
public class NotificationAsserts {
    ...
    public static void assertNotificationUpdatableFieldsEquals(Notification expected, Notification actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getRecipientEmail()).as("check recipientEmail").isEqualTo(expected.getRecipientEmail()))
            .satisfies(a -> assertThat(a.getRecipientPhone()).as("check recipientPhone").isEqualTo(expected.getRecipientPhone()));
    }
