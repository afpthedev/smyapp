...
public class NotificationTestSamples {
    ...
    public static Notification getNotificationSample1() {
        return new Notification().id(1L).message("message1").recipientEmail("recipientEmail1").recipientPhone("recipientPhone1");
    }

    public static Notification getNotificationSample2() {
        return new Notification().id(2L).message("message2").recipientEmail("recipientEmail2").recipientPhone("recipientPhone2");
    }
