...
import { Card, Typography, DatePicker, Select, Tag, Progress, List, Avatar, Space, Divider } from 'antd';
import { CalendarOutlined, ArrowUpOutlined, ArrowDownOutlined, TeamOutlined, DollarCircleOutlined } from '@ant-design/icons';
import './styles.css';
